      ...
      <div className="max-w-2xl sm:py-6 mx-auto">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form
            className="space-y-4"
            onSubmit={(e) =>
              toast.promise(handelSaveProfile(e), { loading: `Saving...` })
            }
          >
            {/*Profile Picture*/}
              ...
              >
                ...
                <div className="group/profile relative">
                  <img
                    ...
                    alt=""
                    className="w-80 h-40 rounded-lg bg-linear-to-r from-indigo-200 vai-purple-200 to-pink-500 object-cover mt-2"
                  />
